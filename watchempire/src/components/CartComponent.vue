<template>
  <section class="w-full min-h-[33rem] bg-gray-200 p-1 pb-20">
    <div class="w-5/6 h-20 m-auto mt-12 flex items-center justify-between">
      ...
      <router-link to="/tienda" class="text-xl"
        ><i class="fas fa-arrow-left"></i> Seguir comprando</router-link
      >
    </div>
        ...
        <div class="w-2/5 h-full px-5">
          ...
          <div class="flex items-center">
            ...
            <label
              ...
              class="ms-2 text-base font-medium text-gray-900"
              >Envío a domicilio = 20% de recargo</label
            >
          </div>
        </div>

        <div class="w-2/5 h-full px-5 flex flex-col items-start justify-center">
            <h3 class="w-5/6 p-3">Subtotal: <span class="float-right font-bold">240000 $</span></h3>
            <h3 class="w-5/6 p-3 my-5">Envío: <span class="float-right font-bold">Gratis</span></h3>
            <h2 class="w-5/6 p-3 bg-cyan-400 rounded-lg">TOTAL: <span class="float-right font-bold">240000 $</span></h2>
        </div>
      </div>
    </div>
  </section>
